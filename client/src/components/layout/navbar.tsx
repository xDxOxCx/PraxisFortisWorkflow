          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block ml-10">
              <div className="flex items-baseline space-x-8">
                ...
                <Link href="/workflow-builder">
                  <a className={`px-3 py-2 text-sm font-medium transition-colors ${isActive('/workflow-builder') || location.startsWith('/workflow-builder')
                      ? 'text-slate-blue'
                      : 'text-silver-gray hover:text-emerald-green'}`}>
                    New Workflow
                  </a>
                ...
                <Link href="/templates">
                  <a className={`px-3 py-2 text-sm font-medium transition-colors ${isActive('/templates')
                      ? 'text-slate-blue'
                      : 'text-muted-foreground hover:text-emerald-green'}`}>
                    Templates
                  </a>
                ...
                <Link href="/settings">
                  <a className={`px-3 py-2 text-sm font-medium transition-colors ${isActive('/settings')
                      ? 'text-slate-blue'
                      : 'text-muted-foreground hover:text-emerald-green'}`}>
                    Settings
                  </a>
...
```
There are some duplicated code, let me remove it